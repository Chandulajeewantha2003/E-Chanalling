...
%>
<% if (error != null) { %>
    <div id="errorPopup" class="alert alert-danger text-center shadow" style="position: fixed; top: 20px; left: 50%; transform: translateX(-50%); z-index: 9999;">
        <%= error %>
    </div>
<% } %>
...
<!-- Auto-hide error popup after 5 sec -->
<script>
