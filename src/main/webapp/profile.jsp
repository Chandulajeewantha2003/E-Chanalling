...
<div class="container bg-white p-4 rounded shadow" style="max-width: 500px;">
    ...
    <% if (profileExists) { %>
        <form action="UpdateProfileServlet" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="tel" name="telephone" value="<%= telephone %>" pattern="\\d{10}" maxlength="10" class="form-control" required />
                <div class="form-text text-muted">Enter 10-digit telephone number.</div>
            </div>

            <button type="submit" class="btn btn-primary w-100">Update Profile</button>
        </form>

        <!-- Delete Profile Data Button (triggers modal) -->
    ...
    <% } else { %>
        ...
        <form action="CreateProfileServlet" method="post" class="mt-3">
            ...
            <div class="mb-3">
                <label class="form-label">Telephone:</label>
                <input type="tel" name="telephone" pattern="\\d{10}" maxlength="10" class="form-control" required />
                <div class="form-text text-muted">Enter 10-digit telephone number.</div>
            </div>
...
<!-- Bootstrap Bundle JS (includes Popper.js for modals) -->
